...
describe( 'App integration test:', () => {
    ...
    describe( 'user clicks `Start Game` button:', () => {
        ...
        describe( 'assume that user is out of time:', () => {
            const ProgressBarComponent = wrapper.find( 'ProgressBar' ).instance();
            ProgressBarComponent.props.timeElapsed();
            const AppComponent = wrapper.find( 'App' ).instance();
            const hasTimeElapsed = AppComponent.props.hasTimeElapsed;
